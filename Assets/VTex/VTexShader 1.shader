Shader "VTex/VTexShadernoscroll"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {   
                ...
                float charaindex = floor(LINEHEIGHT - xy.y) * LINEWIDTH + floor(xy.x) ;//+ floor(_Time.y * 2) % 8000 * LINEWIDTH;//+ (floor(_Time.y * 10) % 1000) * LINEWIDTH;

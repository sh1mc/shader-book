...
Shader "arktoon/AlphaCutoutVTex" {
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _FonTex;
            uniform float4 _FonTex_ST;
            uniform sampler2D _TexTex;
            uniform float4 _TexTex_ST;
            uniform float _Page;
            uniform float _IsDark;
            ...
            #include "cginc/arkludeFragVTex.cginc"
